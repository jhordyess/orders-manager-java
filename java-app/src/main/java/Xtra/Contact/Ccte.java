...
public final class Ccte implements General {
  ...
  public ArrayList<Upload> getArr() {
    ...
    arr.add(new Upload(this.getUpdate(), 1, "upyContR", false, this.getFrms(), true));
    arr.add(new Upload(this.getCreate(), 0, "neoCont", false, this.getFrms(), false));
    arr.add(new Upload(this.elimina(), 50, "delCont", false, null, true));
    arr.add(new Upload(this.updateRem(), 50, "mpvContR", true, null, true));
    return arr;
  }
