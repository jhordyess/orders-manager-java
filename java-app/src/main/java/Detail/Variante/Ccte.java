...
public final class Ccte implements General {
  ...
  public ArrayList<Upload> getArr() {
    ...
    arr.add(new Upload(this.getUpdate(), 1, "varupd", false, this.getFrms(), true));
    arr.add(new Upload(this.getCreate(), 0, "nevar", false, this.getFrms(), false));
    arr.add(new Upload(this.elimina(), 50, "elcvar", false, null, true));
    arr.add(new Upload(this.updateRem(), 50, "habvar", true, null, true));
    return arr;
  }
