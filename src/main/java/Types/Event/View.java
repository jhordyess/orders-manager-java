...
public class View implements core.Views.View {
  ...
  public String ReadFormat(String fly) {
    ...
    if (nets.getReads().equals(fly) || fly.equals("")) {
      ...
      lst.addSelItem("Cambiar a Distribuidor", "fa-id-card", nets.distrib(), 2, true);
      lst.addSelItem("Cambiar Representante", nets.representa(), (new Model()).getCLientes(), true);
      lst.setSel();
      // Botones de cabezera
      lst.addButtonItem("Eventos", "fa-calendar-alt", nets.getReads(), true);
      ...
      lst.addTableColSel();
      lst.addTableColDet();
      lst.addTableColFoo(true, "Nombre de evento");
