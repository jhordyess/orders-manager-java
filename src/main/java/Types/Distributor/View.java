...
public class View implements core.Views.View {
  ...
  public String ReadFormat(String fly) {
    ...
    if (nets.getReads().equals(fly) || fly.equals("")) {
      ...
      lst.addSelItem("Quitar representante", "fa-trash", nets.drorep(), 2, false);
      lst.addSelItem("Cambiar a Evento", "fa-building", nets.evento(), 2, true);
      lst.addSelItem("Cambiar Representante", nets.representa(), (new Model()).getCLientes(), true);
      lst.setSel();
      // Botones de cabezera
      lst.addButtonItem("Distribuidores", "fa-calendar-alt", nets.getReads(), true);
      ...
      lst.addTableColSel();
      lst.addTableColDet();
      lst.addTableColFoo(true, "Nombre de distribuidor");
      lst.addTableColFoo(true, "Nombre de representante");
  ...
  public String UpdateFormat(String key, String selec) {
    ...
    if (nets.getUpdate().equals(key)) {
      ...
      xp.setElem("Distribuidor");
      xp.setMesage("El cliente por defecto sera desconocido.");
